"""shulesmart_1701 URL Configuration
...
admin.site.site_header = 'ShuleSmart'
admin.site.site_title = 'ShuleSmart Admin Portal'
admin.site.index_title = 'ShuleSmart Admin'
